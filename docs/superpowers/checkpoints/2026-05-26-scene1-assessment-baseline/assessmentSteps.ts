export type AssessmentStepId = 1 | 2 | 3 | 4 | 5 | 6 | 7;
...
export const assessmentSteps: AssessmentStepDefinition[] = [
  ...
  },
  {
    ...
    options: {
      ...
      cycleChange: [
        ...
        { value: 'longer', label: '周期延长（两个月才来一次，或间隔超过60天）' },
  ...
  },
  {
    id: 4,
    title: '这些症状最近对你影响大吗？',
    subtitle: '请按最近一段时间的真实感受作答。',
    requiredFields: ['symptomLevel', 'emotionLevel'],
    options: {
      symptomLevel: [
        { value: 'none', label: '无' },
        { value: 'mild', label: '轻度' },
      ...
      emotionLevel: [
        { value: 'none', label: '没有明显波动' },
        { value: 'mild', label: '偶尔烦躁' },
        { value: 'medium', label: '情绪起伏明显' },
        { value: 'high', label: '已经影响日常生活' },
      ],
    },
  },
  {
